...
const Checkout = (props) => {
  ...
  const confirmHandler = (event) => {
    ...
    const enteredPosatalCode = postalCodeInputRef.current.value;
    ...
    const enterPostalCodeIsValid = isFivechars(enteredPosatalCode);

    setFormInputValidity({
      name: enterCityIsValid,
